...
//    y: parent.height / 2 - height / 2
    ...
    enter: Transition {
         ParallelAnimation{
             ...
             NumberAnimation { property: "y"; from: 1920; to: parent.height / 2 - height / 2 ; duration: loadingProgress.showDuration; easing.type: Easing.OutCirc}
         }
    }
    exit: Transition {
        ParallelAnimation{
            NumberAnimation { property: "opacity"; from: 1.0; to: 0.0;  duration: loadingProgress.hideDuration}
            NumberAnimation { property: "y"; from: parent.height / 2 - height / 2 ; to: 1920; duration: loadingProgress.hideDuration; easing.type: Easing.OutCirc}
        }
    }
}
